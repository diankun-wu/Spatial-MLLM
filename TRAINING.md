...
- `route_plan_scannet_2k`: A subset of route planning data used in [VLM-3R](https://github.com/om-ai-lab/VLM-R1), containing around 2k samples from ScanNet.
...
- `route_plan_4k`: Route planning data used in [VLM-3R](https://github.com/om-ai-lab/VLM-R1).
